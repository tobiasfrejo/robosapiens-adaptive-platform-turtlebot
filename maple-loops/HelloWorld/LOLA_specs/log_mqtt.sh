...
CMD="docker run --network host -it --rm -e RUST_BACKTRACE=full -v $HOSTDIR:/mnt/host_models trustworthiness-checker /mnt/host_models/$SPECBASE --input-mqtt-topics $IN_TOPICS  --output-mqtt-topics $OUT_TOPICS"
