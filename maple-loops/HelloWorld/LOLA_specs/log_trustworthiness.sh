...
CMD="docker run --network host -it --rm -e RUST_BACKTRACE=full -v $HOSTDIR:/mnt/host_models thomasdwright/trustworthiness-checker:latest /mnt/host_models/$SPECBASE --input-mqtt-topics $IN_TOPICS"
